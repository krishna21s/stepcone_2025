...
export const UI = () => {
  ...
  useEffect(() => {
    const audio = new Audio("/stepcone/sbook/audios/page-flip-01a.mp3");
    audio.play();
  }, [page]);
  ...
  const handleClick = () => {
    ...
    const clickNextButton = () => {
      window.open("/stepcone/sbook/soviner_book_2025.pdf", "_blank");
    };
        ...
        <div className="d-flex justify-content-between align-items-center">
          <div>
            <img
              ...
              src="/stepcone/sbook/images/STEPCONE.png"
            />
          </div>
          <div className="">
            <button
              className="play-btn btn btn-sm btn-outline-light px-3 py-2 rounded-6  mx-3 "
              onClick={handleClick}
            >
              Download PDF
            </button>
      ...
      <div className="fixed inset-0 flex items-center -rotate-2 select-none">
        <div className="relative">
          <div className="bg-white/0  animate-horizontal-scroll flex items-center gap-8 w-max px-8">
            <h2 className="shrink-0 text-white text-12xl text-sm-10xl">
              STEPCONE
            </h2>
