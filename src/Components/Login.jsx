    ...
    return (
        <>
            ...
            <div className="login-main d-flex flex-column justify-content-center gap-2 align-items-center " id='login-main'>
                ...
                {/* Login Form */}
                <div className="container login-box1 d-flex flex-column justify-content-center align-items-center">
                    <div className="fs-2 mt-2 border-bottom border-warning">
                        LOG-IN
                    </div>
                        ...
                        <div className="row m-auto">
                            <div className="col-12 col-md-6 d-flex align-items-center justify-content-center">
                                <div className="login-form w-100">
                                    ...
                                    <Link
                                        to={`/${encodePath("/stepcone_$_@&&& 530$215 3478rg3 fv348r34 && --signup")}`}
