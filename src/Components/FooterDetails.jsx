    ...
    return (
        <>
                ...
                <div className='col-3 py-3'>
                    <center>
                        ...
                        <div>
                            ...
                            <div><Link to='/termsconditions'>Terms & Conditions</Link></div>
                ...
                <div className='col-3  py-3'>
                    <center>
                        ...
                        <div className=''>
                            ...
                            <div><a href="mailto:gmrit@gmrit.edu.in">gmrit@gmrit.edu.in</a></div>
                            <div><a href="mailto:stepcone@gmrit.edu.in">stepcone@gmrit.edu.in</a></div>
                            <div><a href="">Help Desk: +917075590320</a></div>
            ...
            <div className='copyright text-center'>
                <small className='text-dark'>© Copyright 2025. All rights reserved.</small>
            </div>
        </>
    )
}
